/*
	This program is to find both the addition and subtraction of two matrices
	Firstly add order of 2 matrices one by one
	Then add the elements
	As output you will get 1st addition of matrices and then subtraction of matrices
*/
#include<stdio.h>
int main()
{
